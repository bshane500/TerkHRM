...
<div class="modal fade" id="add_branch" tabindex="-1" role="dialog" aria-labelledby="branchLabel" aria-hidden="true">
  ...
  <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <select id="region" name="region" class="select select-primary select-block mbl form-control ">
