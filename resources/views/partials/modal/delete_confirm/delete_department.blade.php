<div class="modal fade" id="department_delete" tabindex="-1" role="dialog" aria-labelledby="departLabel" aria-hidden="true">
  <div class="modal-dialog">
      <div class="modal-content">
        ...
        <p>You are about to delete a department, Are you sure?</p>       
