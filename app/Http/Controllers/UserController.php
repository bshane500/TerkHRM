<?php
    ...
    class UserController extends Controller
    {
        ...
        public function index()
        {
            ...
            return view('manage_pages.employees', compact('employees'));
        }
        ...
        {
            //TODO Soft Delete Employees and move them to archive table
            $this->users->delete($id);
            return redirect(route('employees.index'))->with('status', 'Employee Successfully ');
        }
    }
